...
int main(int argc, char** argv) {
    ...
    ObjLoader *octopus = new ObjLoader("obj_files/octopus/OCTOPUS_", "obj_files/octopus/");
    ...
    //ObjLoader
    // Octopus
    /* vector<Object*> veco = octopus->getObjects(); */
    /* for (unsigned int i = 0; i < veco.size(); i++) { */
    /*     log_console.infoStream() << "Adding child: octopus_" << i; */
    /*     stringstream s; */
    /*     s << "cube2_" << i; */
    /*     root->addChild(s.str(), veco[i]); */
    /* } */
